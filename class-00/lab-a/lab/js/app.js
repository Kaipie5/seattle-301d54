...
function displayPics(){
  ...
  // because const causes the variable to only be accessible in the block of code in which it is declared. 
  // Since rando was declared inside the while loop it could not be accessed outside that while loop
  console.log(viewed);
