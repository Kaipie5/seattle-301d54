...
//   - this is the object the scope method is a prototype for. In this case this refers to the object Joe.
//
// 2. What is "this" when joe.scopeArrow() is invoked?
//  - The this is the object encapsulating the object the function is acting on, in this case the object encapsulating student is the window.
//
// 3. Explain why "this" is different when an arrow function is used.
// - Because arrow functions don't have a reference to this defined within them, so they go to their parent object and grab the parent objects this reference.
